...
def vicon_feed():
    ...
    while True:
        try:
            ...
            # VELOCITY ZEROED — confirmed fix for EKF variance dropouts.
            # EKF derives velocity from position changes itself; the raw
            # frame-to-frame velocity was spiking and destabilising it.
